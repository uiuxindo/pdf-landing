...
export default function ThankYouPage() {
  return (
    ...
    >
      <div
        className="d-flex flex-column flex-md-row align-items-center justify-content-center bg-white rounded-4 p-4 p-md-5 shadow thankyou-container"
        style={{
          backgroundImage: "url('/Assets/BG-thankyou.png')",
      ...
      >
        ...
        <div className="text-start text-container">
          <p className="fw-700 mb-4" style={{fontSize:'20px'}}>
          ...
          <Link
            href="/"
            className="btn fw-bold rounded-pill px-4 thankyou-btn"
          >
