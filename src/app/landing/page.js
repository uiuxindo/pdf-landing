...
import Navbar from "./Navbar/navbar-lp";
...
import AccordionGallerySection from "./AccordionGallery";
    ...
    <>
      ...
      <div className="container-fluid">
        <div className="row" style={{paddingBottom:'50px'}}>
          ...
          {/* Hero */}
          <div className="col-12 px-0 py-5 py-md-0" 
               style={{
      ...
      <div className="container">
        ...
        <div className="row" style={{paddingBottom:'72px'}}>
          <div className="col-12 col-md-4 text-center" style={{borderRight: 'solid 1px #E0E0E0'}}>
            ...
            <p className="text-grey fs-lg">Total Participants</p>
          </div>
          <div className="col-12 col-md-4 text-center" style={{borderRight: 'solid 1px #E0E0E0'}}>
            <h2 className="text-pink mb-1 fw-700">200+</h2>
            <p className="text-grey fs-lg">Total Speakers</p>
          </div>
          <div className="col-12 col-md-4 text-center">
            <h2 className="text-pink mb-1 fw-700">50+</h2>
            <p className="text-grey fs-lg">Partners</p>
          </div>
        </div>
        ...
        <div className="row" style={{paddingBottom:'72px'}}>
          <div className="col-12 col-md-5">
            <Image className="mb-4 mb-md-0 img-fluid" src="/Assets/Laptop 2.png" width={450} height={450} alt=""/>
          </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="row mt-4">
            ...
            <div className="col-md-6 col-12 mt-4 mt-md-0 px-0 px-md-3 py-0">
              <Card className="card border-0 rounded-4 card-benefit mb-3" style={{
                ...
                <Card.Body className="px-0">
                  ...
                  <ul className="ps-4 pt-2" style={{listStyleType:'none'}}>
        ...
        {/* Timeline */}
        <h1 className="text-pink fw-700 text-center" style={{fontSize:'32px', marginTop:'100px'}}>Event Schedule</h1>
        <div className="row">
          <div className="col-12 text-center">
            <Image className="mb-md-0 img-fluid" src="/Assets/Timeline.png" width={1400} height={800} alt=""/>
          </div>
        </div>
      </div>
            ...
            <div className="row mt-5">
              <div className="col-md-6 col-12 position-relative mb-3 mb-md-0 px-3">
                ...
                <Card className="card-price px-4 py-4 mb-0 rounded-4" style={{height:'210px'}}>
                  <Card.Body className="d-flex flex-md-row flex-column align-items-center justify-content-center p-0">
                    <Card.Title className="title-price h-100 border-end text-center pe-md-5">
              ...
              <div className="col-md-6 col-12 position-relative px-3">
                ...
                />
                 <Card className="card-price px-4 py-4 mb-0 rounded-4" style={{height:'210px'}}>
                  <Card.Body className="d-flex flex-md-row flex-column align-items-center justify-content-center p-0">
                    <Card.Title className="title-price h-100 border-end text-center pe-md-3">
      ...
      <div className="container-fluid" style={{marginTop:'100px', marginBottom:'100px'}}>
        <div className="row">
          <div className="col-12 px-md-0 px-1 py-5 text-center bg-momen" 
              style={{
            ...
            <Accordion defaultActiveKey="0">
              <div className="row">
                <div className="col-md-6 col-12">
                  ...
                  <Accordion.Item className="border rounded-4 overflow-hidden" eventKey="2">
      ...
      {/* CTA Contact Us */}
        <div className="row">
          <div className="col-12 px-0 py-5 rounded-4" 
              style={{
              ...
              <div className="d-flex flex-md-row flex-column justify-content-between align-items-center contact-cta" style={{paddingLeft:'100px', paddingRight:'100px'}}>
                <div className="w-75 p-4 rounded-4" style={{background:'#FFF1C6'}}>
                ...
                <Image className="mb-md-0" src="/Assets/contact-us.png" width={450} height={450} alt=""/>
              </div>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <footer className="mt-5" style={{borderTop:'solid 3px #E7E7E7'}}>
