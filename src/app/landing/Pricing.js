            ...
            <div className="col-md-6 col-12 position-relative mb-3 mb-md-0 px-3" key={index}>
              ...
              >
                <Card.Body className="h-100 d-flex flex-column align-items-center justify-content-center p-0">
                  <div className="w-100 d-flex justify-content-center align-items-center border-bottom pb-3">
                    <div className="text-main fw-700 fs-2xl me-3">{dataPrice.title}</div>
                    {isBestOption && (
                  ...
                  <div className="d-flex flex-md-row flex-column align-items-center justify-content-center my-md-4 card-content">
                    ...
                    <ul className="ps-0 ps-md-5 pe-4 pe-md-0 mb-md-0 mb-3 text-start" style={{ listStyleType: "none" }}>
                  ...
                  {/* Button */}
                  <Link href={dataPrice.link} className="btn btn-price rounded-pill w-100 fw-600">
                    Beli Tiket
                  </Link>
                </Card.Body>
              </Card>
